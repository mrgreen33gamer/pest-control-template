...
// ShieldPro Pest Control — Contact Page (unique build, not just a form import)
...
const SERVICES = [
  ...
  'Mosquito Treatment', 'Bed Bug Treatment', 'Commercial Pest Control',
...
const faq = [
  {
    ...
    answer: "Call us directly at (254) 776-3300. We answer 7 days a week including evenings. For a genuine pest emergency in Central Texas, call — don't wait on a form response.",
  },
  {
  ...
  {
    question: 'Do you work on commercial pest programs?',
    answer: 'Yes — light commercial pest control for restaurants, offices, retail spaces, and small warehouses is within our scope. Call to discuss your specific facility and location.',
  },
  {
  ...
  },
  {
    ...
    answer: "Our tech will tell you honestly after the diagnosis. Our technician will identify the pest and recommend a one-time treatment or recurring plan based on pressure — you'll always see options and pricing before we proceed.",
  },
];
  ...
  return (
    <main className={styles.page}>
        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  ...
                  label:     'Email',
                  value:     'hello@shieldpropest.com',
                  href:      'mailto:hello@shieldpropest.com',
                ...
                },
                {
                  ...
                  label:     'Address',
                  value:     '1800 N Valley Mills Dr, Waco TX 76710',
                  href:      'https://maps.google.com/?q=1800+N+Valley+Mills+Dr+Waco+TX+76710',
            ...
            <div className={styles.trustBlock}>
              <p className={styles.trustHeading}>Why homeowners choose ShieldPro</p>
              {[
                'Flat-rate pricing — written quote before we start',
                'Free re-treat if pests return between visits',
                'Licensed Pest Control Applicators only',
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successCard}
                  ...
                  <p className={styles.successText}>
                    A licensed ShieldPro electrician will reach out shortly — usually within one business day. For urgent needs, call us at{' '}
                    <a href="tel:+12547763300">(254) 776-3300</a>.
                  </p>
      ...
      <CTABanner
        ...
        subline="Call (254) 776-3300 — we answer 7 days a week, evenings included. Emergency service available across Central Texas."
        primaryText="Call (254) 776-3300"
        primaryLink="tel:+12547763300"
        secondaryText="Send a Text"
        secondaryLink="sms:+12547763300"
      />
