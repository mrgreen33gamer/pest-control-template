...
// ShieldPro Pest Control — Service Areas Page
'use client';
...
const SERVICE_AREAS = [
  {
    ...
    badge:       'Home Base',
    description: 'Our headquarters. Fastest response times, same-day service available 7 days a week. Full pest control repair, termite service, rodents, mosquitoes, bed bugs, and commercial programs across all of Waco.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       'Primary Area',
    description: 'Full pest control coverage for Hewitt homes and businesses. Fast dispatch from our Waco base — typically under 45 minutes.',
    highlights:  ['45-min dispatch', 'Residential & commercial', 'Termite service'],
  },
  {
    city:        'Woodway',
    slug:        'woodway-tx',
    county:      'McLennan County',
    badge:       'Primary Area',
    description: "Serving Woodway's residential neighborhoods with the same flat-rate pricing and Free Re-Treat Guarantee as every other area we cover.",
    highlights:  ['Flat-rate pricing', 'Free Re-Treat Guarantee', 'Licensed'],
  },
  {
    city:        'Bellmead',
    slug:        'bellmead-tx',
    county:      'McLennan County',
    badge:       '',
    description: 'Reliable pest control service for Bellmead residents and businesses. Termite service, repairs, and lighting installs — same-day when available.',
    highlights:  ['Residential & commercial', 'Licensed electricians', 'No contracts'],
  },
  {
    city:        'China Spring',
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Rural and residential pest control service for the China Spring area. We make the drive — flat-rate pricing applies just the same.',
  ...
  },
  {
    ...
    county:      'McLennan County',
    badge:       '',
    description: 'Pest Control repair, termite service, and outbuilding coverage for McGregor homes and light industrial properties.',
    highlights:  ['Shop & residential', 'Termite service', 'Same-day when available'],
  },
  {
    city:        'Killeen',
    slug:        'killeen-tx',
    county:      'Bell County',
    badge:       '',
    description: 'Pest Control repair, installation, and upgrades for Killeen and Fort Cavazos area homes and businesses. Military-friendly scheduling.',
  ...
  },
  {
    ...
    county:      'Bell County',
    badge:       '',
    description: 'Full-service pest control coverage for Temple. Medical district and surrounding neighborhoods served. Full residential and commercial pest control.',
...
const faq = [
  ...
  {
    question: 'Do you work on commercial pest control in all areas?',
    answer: 'Yes — light commercial pest control for restaurants, offices, retail spaces, and small warehouses is within scope across all our coverage areas. Call to discuss your specific project and location.',
  },
  {
    ...
    <main className={styles.page}>
        ...
        <div className={styles.heroInner}>
          ...
          >
            <div className={styles.heroBadge}>
              ...
              Central Texas Pest Control — Since 2010
            </div>
            ...
            <p className={styles.heroSub}>
              Based in Waco, serving all of Central Texas. Flat-rate pricing, Licensed electricians, and a Free Re-Treat Guarantee — no matter where you are.
            </p>
            <div className={styles.heroActions}>
              <a href="tel:+12547763300" className={styles.heroCTAPrimary}>
        ...
        <div className={styles.areasSectionInner}>
          <div className={styles.sectionHeader}>
            ...
            <p className={styles.sectionSub}>
              Click any city to see local service details, common pest control issues in your area, and what to expect from our team.
            </p>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className={styles.areaFooter}>
                    <a href="tel:+12547763300" className={styles.areaCallBtn}>
      ...
      <section className={styles.unlisted}>
        <div className={styles.unlistedInner}>
          ...
          <a href="tel:+12547763300" className={styles.unlistedCTA}>
            Call (254) 776-3300
          </a>
        </div>
      </section>
      ...
      <CTABanner
        ...
        subline="Same-day service available across Central Texas. Flat-rate pricing, Free Re-Treat Guarantee, no contracts ever."
