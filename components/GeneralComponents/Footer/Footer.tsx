...
import {
  ...
  faShieldHalved, faBug, faClock, faLeaf,
...
const SERVICE_LINKS = [
  ...
  { href: '/services/termite-inspection-treatment', label: 'Termite Inspection' },
  { href: '/services/rodent-control',              label: 'Rodent Control' },
  { href: '/services/mosquito-yard-treatment',     label: 'Mosquito Treatment' },
  { href: '/services/bed-bug-treatment',           label: 'Bed Bug Treatment' },
  { href: '/services/commercial-pest-control',     label: 'Commercial Pest Control' },
];
...
const TRUST_ITEMS = [
  ...
  { icon: faBug,          label: 'Licensed Applicators' },
  { icon: faClock,        label: 'Same-Day Service' },
  { icon: faLeaf,         label: 'Eco-Conscious Options' },
];

const SOCIALS = [
  { href: 'https://facebook.com/shieldpropest', icon: faFacebookF, label: 'Facebook' },
  { href: 'https://g.page/r/shieldpropest',     icon: faGoogle,    label: 'Google' },
];
          ...
          <div className={styles.brandCol}>
            <Link href="/" className={styles.logo}>
              ...
              <div className={styles.logoText}>
                <span className={styles.logoName}>ShieldPro Pest Control</span>
      ...
      <div className={styles.bottomBar}>
        <div className={styles.bottomInner}>
          <p className={styles.copyright}>
            &copy; {new Date().getFullYear()} ShieldPro Pest Control. All Rights Reserved. | Licensed Pest Control Applicator
          </p>
          <a href="tel:+12547763300" className={styles.emergencyBtn}
