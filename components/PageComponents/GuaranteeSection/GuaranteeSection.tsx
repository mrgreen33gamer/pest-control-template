...
const DEFAULT_GUARANTEES: Guarantee[] = [
  ...
  },
  {
    ...
    description:
      "If covered pests return between scheduled visits, we come back and re-treat at no charge. That is our Satisfaction Guarantee in writing.",
  },
  {
    icon: faRotateLeft,
  ...
  {
    icon: faCertificate,
    title: "Licensed Pest Control Applicators",
    description:
      "Every technician who treats your property is a Licensed Pest Control Applicator. Fully insured. Eco-conscious options available on request.",
  },
  {
    icon: faCalendarCheck,
    title: "No Contracts. No Lock-In.",
    description:
      "Recurring plans are flexible. We earn your business with every visit — not by holding you hostage with a multi-year contract.",
  },
  {
    icon: faStar,
      ...
      <div className={styles.container}>
        ...
        <div className={styles.leftCol}>
          ...
          <p className={styles.body}>
            Every pest company in Central Texas makes promises. We back ours in writing — with licensed applicators, free re-treats between visits, and eco-conscious options when you want them.
          </p>
          <Link
            href={ctaLink}
          ...
          <div className={styles.ratingRow}>
            ...
            <span className={styles.ratingText}>4.9 · 890+ verified Google reviews</span>
          </div>
        </div>
