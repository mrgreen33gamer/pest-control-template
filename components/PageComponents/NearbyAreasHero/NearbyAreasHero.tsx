...
export default function NearbyAreasHero({
  ...
  const displayHeadline = headline ?? `Pest Control in ${cityName}, TX`;
  const displayDesc     = description ??
    `ShieldPro Pest Control provides fast, reliable pest protection to ${cityName} and all surrounding communities. Licensed applicators, free re-treat guarantee, eco-conscious options available.`;
    ...
    <section className={styles.section}>
      ...
      <div className={styles.container}>
        ...
        >
          ...
          <a href="tel:+12547763300" className={styles.phoneBtn}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
