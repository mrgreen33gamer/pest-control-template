      ...
      <div className={styles.heroContainer}>
        ...
        >
          ...
          <h1 className={styles.heroTitle}>
            Central Texas Pest Control<br />
            <em>Done Right.</em><br />
            Every Time.
          </h1>
          <p className={styles.heroSubtitle}>
            ShieldPro Pest Control has been powering homes and businesses in{' '}
          ...
          <div className={styles.statRow}>
            ...
            <div className={styles.stat}>
              ...
              <span className={styles.statLabel}>Properties Protected</span>
            </div>
          </div>
          ...
          <div className={styles.imageFrame}>
            <div className={styles.imageWrapper}>
              <Image
                ...
                alt="ShieldPro Pest Control — Waco, Texas pest technicians"
                fill
            ...
            <div className={styles.trustCard}>
              ...
              <div className={styles.trustCardText}>
                <span className={styles.trustCardTitle}>ShieldPro Pest Control</span>
                <span className={styles.trustCardSub}>Waco's Most Trusted Electrician</span>
              </div>
            </div>
          </div>
        </motion.div>
