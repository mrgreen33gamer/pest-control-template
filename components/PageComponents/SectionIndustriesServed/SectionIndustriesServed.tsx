...
const INDUSTRIES = [
  ...
  { slug: 'restaurants-food-service', label: 'Restaurants & Food Service', icon: faUtensils },
  { slug: 'healthcare-facilities',    label: 'Healthcare Facilities',    icon: faHospital },
];
...
export default function SectionIndustriesServed({
  ...
  subtitle = 'Specialized pest programs — built for how your property or facility actually operates.',
  disableLinks = false,
