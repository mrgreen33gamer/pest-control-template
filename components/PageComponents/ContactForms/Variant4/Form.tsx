...
const SERVICES = [
  { icon: faFan,             label: 'General Pest Control',        sub: 'Ants, roaches, spiders, seasonal pests' },
  { icon: faFire,            label: 'Termite Inspection', sub: 'Inspection, baiting, liquid treatment' },
  { icon: faWrench,          label: 'Rodent Control',  sub: 'Mice, rats, exclusion & cleanup' },
  { icon: faFilter,          label: 'Mosquito Treatment',     sub: 'Yard barrier & breeding-site treatment' },
  { icon: faThermometerHalf, label: 'Bed Bug Treatment',       sub: 'Inspection, heat/chemical protocols' },
  { icon: faWind,            label: 'Commercial Pest',       sub: 'Restaurants, multi-unit, facilities' },
  { icon: faBolt,            label: 'Emergency',         sub: 'Active infestation, urgent response' },
];
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successState}
                  ...
                  <p className={styles.successText}>
                    A licensed ShieldPro technician will reach out about your <strong>{selectedService}</strong> service.
                  </p>
