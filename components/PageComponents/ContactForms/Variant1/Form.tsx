...
const SERVICES = [
  { icon: faFan,             label: 'General Pest Control' },
  { icon: faFire,            label: 'Termite Inspection' },
  { icon: faWrench,          label: 'Rodent Control' },
  { icon: faFilter,          label: 'Mosquito Treatment' },
  { icon: faThermometerHalf, label: 'Bed Bug Treatment' },
  { icon: faWind,            label: 'Commercial Pest' },
...
const TRUST_CHIPS = [
  ...
  { icon: faStar,         text: '4.9★ · 890+ reviews' },
];
            ...
            {submitted ? (
              <motion.div key="success" className={styles.successState}
                ...
                <p className={styles.successText}>
                  A licensed ShieldPro techniciannician will reach out shortly. Keep an eye on your inbox and phone.
                </p>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  ...
                  <div className={styles.submitRow}>
                    ...
                    <div className={styles.altContact}>
                      ...
                      <span>Need help now?{' '}
                        <a href="tel:+12547763300"
                          onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Call (254) 776-3300', section: 'ContactForm-V1' })}>
                          Call (254) 776-3300
                        </a>
                      </span>
                    </div>
