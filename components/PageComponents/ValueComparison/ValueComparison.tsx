...
const DEFAULT_ROWS: ComparisonRow[] = [
  ...
  { feature: 'Free re-treat between scheduled visits', us: true,  others: false },
  ...
  { feature: 'Residential & commercial coverage',              us: true,  others: 'Sometimes' },
...
export default function ValueComparison({ rows = DEFAULT_ROWS, title = 'ShieldPro vs. The Other Guys' }: ValueComparisonProps) {
  return (
