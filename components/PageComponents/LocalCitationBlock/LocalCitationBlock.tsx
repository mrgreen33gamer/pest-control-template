...
const LocalCitationBlock: React.FC<LocalCitationBlockProps> = ({
  ...
  googleMapsUrl = 'https://maps.google.com/?q=ShieldPro+Pest+Control+Waco+TX',
  hours         = DEFAULT_HOURS,
  cityName      = 'Waco',
}) => {
  return (
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Based in {cityName}, TX — serving all of Central Texas with licensed pest control applicators.
          </p>
        </div>
